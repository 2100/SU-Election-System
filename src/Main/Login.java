...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String midname = jTextField2.getText().trim();
        String lname = jTextField3.getText().trim();
        String dep = jTextField4.getText().trim();
        ...
        for(Student s : students){
            if(s.getMidname().equalsIgnoreCase(midname) && s.getLname().equalsIgnoreCase(lname) && s.getDepartment().equalsIgnoreCase(dep) && s.getYear().equalsIgnoreCase(year)){
               VotePage vt = new VotePage(s,em);
               vt.setVisible(true);
            }
